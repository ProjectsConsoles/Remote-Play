...
REM  PROBADO Y REVERTIDO (2026-09-18, por segunda vez): -audio_buffer_size 50->20
REM    junto con Opus frame_duration 10->5. El usuario dijo 'se siente peor que
REM    antes' en la Deck, incluso con las retenciones del muxer ya quitadas y
REM    con Opus. Dos pruebas (agosto y hoy) dicen lo mismo: NO bajar el buffer de
